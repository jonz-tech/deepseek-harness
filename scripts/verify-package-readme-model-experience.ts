...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/remote-access/remote-access': { kind: 'none', reason: 'The plugin authenticates and tunnels at the transport and request planes; it registers nothing model-facing.' },
